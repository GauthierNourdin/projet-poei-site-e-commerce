...
public class TestCommandeService {
	...
	public static void main(String[] args) {
		...
		*/
		...
		if(!commandeService.save(commande1)) System.out.println("Echec de l'ajout : commande identique déjà présente");
		System.out.println(commandeService);
		
		if(!commandeService.save(commande2)) System.out.println("Echec de l'ajout : commande identique déjà présente");
		System.out.println(commandeService);
		
		if(!commandeService.save(commande3)) System.out.println("Echec de l'ajout : commande identique déjà présente");
		System.out.println(commandeService);
		
		if(!commandeService.save(commande2)) System.out.println("Echec de l'ajout : commande identique déjà présente");

		if(!commandeService.remove(commande1)) System.out.println("Echec de la suppresion de la commande : cette commande n'est pas présente dans la liste");
		System.out.println(commandeService);
		...
		if(!commandeService.update(commande6)) System.out.println("Echec de l'update de la commande : cette commande n'est pas présente dans la liste");
