...
public class TestProduitService {
	...
	public static void main(String[] args) {
		...
		if (!produitService.save(produit1))
			System.out.println("Echec de l'ajout : produit identique déjà présent");
		System.out.println(produitService);
		...
		if (!produitService.remove(produit1))
			System.out.println("Echec de la suppression : ce produit n'est pas présent dans la liste");
		System.out.println(produitService);
		...
		if (!produitService.update(produit3))
			System.out.println("Echec de la mise à jour : ce produit n'est pas présent dans la liste");
		System.out.println(produitService);
		...
		produitService.findById("00000002").setDescriptionProduit("Console neuve dans sa boîte d'origine non ouverte");
		System.out.println(produitService);
	}
